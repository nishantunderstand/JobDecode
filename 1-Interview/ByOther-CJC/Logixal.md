...
• Which collections have you used in your project and where?																									
• What is a dependency, and where is it defined?																									
• What is an artifact in a dependency?																									
• Which Java and Spring versions are used in your project?																									
• How does an API request reach the correct endpoint?																									
• How does a React.js frontend communicate with a Spring Boot backend?																									
...
Questions included:																									
• Self-introduction																									
• Why is Microservices architecture preferred over Monolithic architecture?																									
• What is Functional Programming?																									
• What are your roles and responsibilities in the project?																									
• How does your team deploy the application to the UAT environment?																									
• How would you handle an urgent production defect?																									
• Which API have you created from scratch?																									
• Write a JPA query to fetch employee details with the maximum age																									
• Common Git commands – Pull, Push, Commit, etc.																									
• During migration from Java 8 to Java 17, which libraries caused compatibility issues?																									
• How do you call an external API from your application? Explain the theory and code flow.																									