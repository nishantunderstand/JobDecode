...
Instance vs Static Block vs Constructor  
...
Can we return this?  
Can we use this in constructor before super()?

# Inner Class

"Nested" means a type is declared inside another type (usually inside a class).
